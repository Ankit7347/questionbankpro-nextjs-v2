...
async function SubjectNotesPage({ params }: PageProps) {
  ...
  try {
    // Call server service directly (NOT through API route)
  ...
  if (error || !data) {
    return (
      <div className="bg-slate-950 text-slate-200 p-4 md:p-6 pb-24">
        <div className="text-center">
          <p className="text-red-400">Failed to load subject chapters</p>
      ...
      <header className="mb-8">
        ...
        <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-slate-900/50 rounded-lg p-3">
            ...
            <p className="text-xl font-bold text-cyan-400">{stats.totalChapters}</p>
          </div>
          <div className="bg-slate-900/50 rounded-lg p-3">
