// src/app/components/student-dashboard/notes/QuickResume.tsx
  ...
  if (!data) {
    return (
      <section>
        ...
        <div className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 flex flex-col items-center justify-center text-center gap-3 min-h-[160px]">
          <div className="w-12 h-12 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400">
            <BookOpen className="w-6 h-6" />
          </div>
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">No recent activity</h3>
            <p className="text-xs text-slate-500 mt-1 max-w-[200px] mx-auto">Start reading notes to track your progress here.</p>
          </div>
        </div>
      </section>
    );
