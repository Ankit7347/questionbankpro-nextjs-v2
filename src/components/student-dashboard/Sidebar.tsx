    ...
    <>
      ...
      <aside
        className={`
          ...
          backdrop-blur-xl bg-white/40 dark:bg-[#0A1224]/40
        ...
        <div className="p-4 space-y-6">
          ...
          {sections.map(section => (
            <div key={section.title}>
              {/* Section Label */}
              <p className="uppercase text-[11px] font-semibold tracking-wider 
                text-gray-500 dark:text-gray-400 mb-2 ml-1">
                {section.title}
              </p>
                  ...
                  <Link key={href} href={href}>
                    <span
                      ...
                      className={`
                        ...
                        ${active
                          ? "bg-blue-100/40 dark:bg-blue-900/30 font-semibold"
                          : "hover:bg-blue-50/40 dark:hover:bg-blue-800/20"
                        }
                      `}
                    >
                      ...
                      <Icon
                        className={`
                          w-5 h-5 text-transparent bg-clip-text
                          ${active
                            ? "bg-gradient-to-br from-blue-600 to-purple-600 dark:from-blue-300 dark:to-purple-400"
